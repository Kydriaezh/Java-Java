...
import HomeWork6_OOP.controller.VendingMachineController;
...
/*
 * В процессе выполнения домашнего задания я постаралась использовать в принцип SOLID в полной мере
 ...
 * 
 * S - Принцип единственной ответвтенности: разделила ответственность между классами Контроллер работает с View и Серивсами, 
